...
function hala_enqueue_scripts() {
	...
	wp_enqueue_style( 'hala-bootstrap', Hala_URI_PATH. '/assets/css/bootstrap.min.css' , array(), '3.3.6');
	...
	wp_enqueue_style( 'hala-style', Hala_URI_PATH.'/style.css', false );
	wp_enqueue_style( 'hala-wp-custom-style', Hala_URI_PATH . '/style.css', false);
    /* script */
	wp_enqueue_script( 'hala-bootstrap-js', Hala_URI_PATH.'/assets/js/bootstrap.min.js', array( 'jquery' ), '3.3.6', true );
	...
	if(isset($hala_options["smooth_scroll"])&&$hala_options["smooth_scroll"]) {
	   wp_enqueue_script( 'hala-smoothscroll-js', Hala_URI_PATH.'/assets/js/smoothscroll.min.js', array( 'jquery' ), '', true );
	}
...
function hala_removeDemoModeLink() { // Be sure to rename this function to something more unique
...
add_action('init', 'hala_removeDemoModeLink');
...
Widgets
/*-----------------------------------------------*/
require_once Hala_ABS_PATH_FR.'/widgets/abstract-widget.php';
require_once Hala_ABS_PATH_FR.'/widgets/widgets.php';
/*-----------------------------------------------*
WooCommerce
/*-----------------------------------------------*/
if (class_exists('Woocommerce')) {
